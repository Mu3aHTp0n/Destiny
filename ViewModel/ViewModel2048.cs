...
namespace Destiny.ViewModel
{
    ...
    internal class ViewModel2048 : OnPropertyChangedClass
    {
        ...
        readonly List<string> modelProperties = new List<string>() { nameof(Model2048.CountEmptyCell), nameof(Model2048.IsGameOver), nameof(Model2048.MaxValue), nameof(Model2048.SumValue) };
